...
/** JAV_07_internal_frame_six demonstrates six Java Internal Frames Six in Java Frame */
...
//------------------------------
    ...
    var title = "JAVA -- JAV_07_internal_frame_six -- v. 2023.12.12";
 ...
 */
    public static void main(String[] args) {
                                             SwingUtilities.invokeLater( () -> { new JAV_07_internal_frame_six(); } );
    }  //  end main()
