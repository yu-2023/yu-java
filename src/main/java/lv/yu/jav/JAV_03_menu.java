...
//------------------------------
    ...
    var icon_Xxxxx       = new ImageIcon(JAV_03_menu.class.getResource("/lv/yu/jav/JAV_resources/xxxx.png"));
...
//------------------------------
    ...
    var menu_Menu = new JMenu("Menu"); 
      ...
      var item_Xxxxx = new JMenuItem("Xxxxx", icon_Xxxxx);
...
//------------------------------
        ...
        menu_Menu.setToolTipText("Menu commands");    
          ...
          item_Xxxxx.setToolTipText("Xxxxx application");          
